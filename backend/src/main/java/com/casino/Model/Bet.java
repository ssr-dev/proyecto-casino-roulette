...
public class Bet {
    ...
    // 🔹 Apuesta a número
    public Bet(User user, double amount, int number) {
        this.user = user;
        this.amount = amount;
    ...
    // 🔹 Apuesta a color
    public Bet(User user, double amount, String color) {
        this.user = user;
        this.amount = amount;
    ...
    // 🔹 Apuesta a tercio
    public Bet(User user, double amount, int tercio, boolean isTercio) {
        this.user = user;
        this.amount = amount;
        this.type = BetType.TERCIO;
        this.tercio = tercio;
    }
